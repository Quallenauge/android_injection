...
const int OMXCameraAdapter::SENSORID_MT9M114 = 312;
...
const CapU32 OMXCameraAdapter::mSensorNames [] = {
    ...
    { SENSORID_MT9M114, "MT9M114" },
    { SENSORID_MT9M114, "Aptina_MT9M114" }
